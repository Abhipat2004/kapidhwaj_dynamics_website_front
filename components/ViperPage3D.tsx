...
export default function ViperPage3D({ product }: { product: any }) {
    return (
        <div style={{ position: 'relative', background: '#03040a' }}>
            ...
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', zIndex: 10 }}>
                ...
                <section style={{ height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingLeft: '8vw', pointerEvents: 'none' }}>
                    <div style={{ color: '#10B981', fontSize: '0.9rem', fontWeight: 800, letterSpacing: 3, marginBottom: 16 }}>
            ...
            <div style={{ height: '400vh' }}>
                <div style={{ position: 'sticky', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: 0, pointerEvents: 'none' }}>
                    <Canvas camera={{ position: [0, 0, 22], fov: 45 }}>
                        ...
                        <directionalLight position={[-10, -5, 5]} intensity={2.5} color="#10B981" /> 
                        <ViperModel />
                    </Canvas>
                </div>
            </div>
